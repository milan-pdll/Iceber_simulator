...
export const MetadataModal: React.FC<MetadataModalProps> = ({
  ...
  return (
    <div className="fixed inset-0 z-50 bg-black/70 backdrop-blur-md flex items-center justify-center p-3 sm:p-6 select-none animate-in fade-in duration-150">
      <div className="bg-white dark:bg-[#0F172A] border border-slate-200 dark:border-[#334155] rounded-2xl w-full max-w-5xl max-h-[90vh] flex flex-col shadow-2xl overflow-hidden transition-colors">
        {/* Header */}
        <div className="border-b border-slate-200 dark:border-[#334155] px-6 py-4 flex items-center justify-between bg-[#FAFAFA] dark:bg-[#1E293B]">
          <div className="flex items-center space-x-3.5">
            <div className="p-2.5 rounded-xl bg-[#0052FF]/10 dark:bg-[#0052FF]/20 border border-[#0052FF]/20 text-[#0052FF] dark:text-[#4D7CFF] shadow-sm">
            ...
            <div>
              ...
              <p className="text-xs text-slate-500 dark:text-slate-400 font-mono mt-0.5 flex items-center gap-2">
                ...
                <span className="font-semibold text-slate-800 dark:text-slate-200">{state.catalogPointer.tableIdentifier}</span>
          ...
          <div className="flex items-center space-x-3">
            {/* Version Switcher */}
            <div className="flex items-center space-x-1.5 bg-white dark:bg-[#0F172A] px-3 py-1.5 rounded-xl border border-slate-200 dark:border-[#334155] text-xs">
              ...
              >
                {metadataLocations.map((loc, idx) => (
                  <option key={loc} value={loc} className="bg-white dark:bg-[#0F172A] text-slate-900 dark:text-white">
        ...
        <div className="bg-[#FAFAFA] dark:bg-[#0F172A] border-b border-slate-200 dark:border-[#334155] px-6 py-2.5 flex flex-wrap items-center gap-y-2 gap-x-6 text-xs font-mono text-slate-600 dark:text-slate-400">
          ...
          <div className="flex items-center space-x-1.5">
            ...
            <span className="font-semibold text-[#0052FF] dark:text-[#4D7CFF]">
        ...
        {/* Tab Navigation */}
        <div className="flex items-center space-x-1 px-6 pt-3 bg-slate-100 dark:bg-[#1E293B] border-b border-slate-200 dark:border-[#334155] font-mono text-xs">
          <button
            onClick={() => setActiveTab('specs')}
            className={`px-4 py-2.5 rounded-t-xl transition-all flex items-center space-x-1.5 border-t-2 uppercase tracking-wider text-[11px] ${
              activeTab === 'specs'
                ? 'bg-white dark:bg-[#0F172A] text-[#0052FF] dark:text-[#4D7CFF] border-[#0052FF] shadow-sm font-semibold'
          ...
          <button
            ...
            className={`px-4 py-2.5 rounded-t-xl transition-all flex items-center space-x-1.5 border-t-2 uppercase tracking-wider text-[11px] ${
              activeTab === 'snapshots'
                ? 'bg-white dark:bg-[#0F172A] text-purple-600 dark:text-purple-400 border-purple-500 shadow-sm font-semibold'
                : 'text-slate-500 dark:text-slate-400 border-transparent hover:text-slate-900 dark:hover:text-slate-200'
            }`}
          >
          ...
          <button
            ...
            className={`px-4 py-2.5 rounded-t-xl transition-all flex items-center space-x-1.5 border-t-2 uppercase tracking-wider text-[11px] ${
              activeTab === 'storage'
                ? 'bg-white dark:bg-[#0F172A] text-emerald-600 dark:text-emerald-400 border-emerald-500 shadow-sm font-semibold'
                : 'text-slate-500 dark:text-slate-400 border-transparent hover:text-slate-900 dark:hover:text-slate-200'
            }`}
          >
              ...
              <div className="flex items-center justify-between gap-3">
                <div className="relative flex-1 max-w-sm">
                  ...
                  <input
                    ...
                    className="w-full pl-8 pr-3 py-1.5 rounded-xl bg-slate-50 dark:bg-[#0F172A] border border-slate-200 dark:border-[#334155] text-xs font-mono focus:outline-none focus:ring-2 focus:ring-[#0052FF] text-slate-900 dark:text-white placeholder:text-slate-400"
                  />
                </div>
                ...
                <div className="flex items-center space-x-2">
                  <button
                    onClick={handleCopy}
                    className="flex items-center space-x-1.5 px-3 py-1.5 rounded-xl bg-white dark:bg-[#1E293B] border border-slate-200 dark:border-[#334155] hover:border-[#0052FF]/40 text-slate-700 dark:text-slate-300 text-xs font-medium transition-all shadow-sm"
                  >
                    {copied ? (
                      <>
                      ...
                      <>
                        <Copy className="w-3.5 h-3.5 text-[#0052FF]" />
                        <span>Copy JSON</span>
                      </>
                    )}
                  </button>
                  ...
                  <button
                    ...
                    className="btn-signature-primary flex items-center space-x-1.5 px-3.5 py-1.5 rounded-xl text-xs font-semibold shadow-sm"
                  >
